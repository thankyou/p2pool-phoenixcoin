...
nets = dict(
    ...
    phoenixcoin=math.Object(
        ...
        BLOCK_PERIOD=90, # s
        SYMBOL='PXC',
        CONF_FILE_FUNC=lambda: os.path.join(os.path.join(os.environ['APPDATA'], 'Phoenixcoin') if platform.system() == 'Windows' else os.path.expanduser('~/Library/Application Support/Phoenixcoin/') if platform.system() == 'Darwin' else os.path.expanduser('~/.phoenixcoin'), 'phoenixcoin.conf'),
